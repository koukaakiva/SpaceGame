...
func _ready():
	...
	#addTextBox(GLOBAL.textbox_icon_type.NONE, lorem);
	$Dialogue.start_dialogue();
	
func addTextBox(var icon_type, var text):
	var instance = GLOBAL.textbox.instance();
...
func _on_Dialogue_Dialogue_Next(ref, actor, text):
	var iconType;
	if(actor == "You"):
		iconType = GLOBAL.textbox_icon_type.LEFT;
	elif(actor == ""):
		iconType = GLOBAL.textbox_icon_type.NONE;
	else:
		iconType = GLOBAL.textbox_icon_type.RIGHT;
